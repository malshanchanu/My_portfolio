        ...
        <footer class="footer">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        <li>
                            <a href="https://www.google.com/maps/search/?api=1&query=Anamaduwa,+Sri+Lanka" style="color: #ccc; text-decoration: none; display: flex; align-items: center;">
                                <i class='bx bx-map'></i><span>Anamaduwa, Sri Lanka</span>
                            </a>
                        </li>
                        <li>
                            <a href="mailto:chanukamalshan2002@gmail.com" style="color: #ccc; text-decoration: none; display: flex; align-items: center;">
                                <i class='bx bx-envelope'></i><span>chanukamalshan2002@gmail.com</span>
                            </a>
                        </li>
                        <li>
                            <a href="tel:+94761964700" style="color: #ccc; text-decoration: none; display: flex; align-items: center;">
                                <i class='bx bx-phone'></i><span>+94 761964700</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 Chanuka Malshan. All Rights Reserved.</p>
